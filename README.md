...
This is a quick demo on how to integrate *m2m* into your http web application project. It also demonstrates how *m2m* can easily break up your application using a microservices architecture pattern.
